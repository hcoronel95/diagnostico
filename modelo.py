...
pkl_filename = "D:/Almacenamiento/Documentos/Tesis_modelo_analisis_Data/Modelo_Arbol_de_Decisiones.pkl"
with open(pkl_filename, 'rb') as file:
    model = pickle.load(file)


# Cargar el archivo local que contiene el dataset
ruta_archivo = 'D:/Almacenamiento/Documentos/Tesis_modelo_analisis_Data/DATA/Data_Final_egresos_y_camillas.csv'
