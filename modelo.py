...
pkl_filename = "./Modelo_Arbol_de_Decisiones.pkl"
...
st.markdown('Esta aplicación te permite la clasificar la mejor opcion segun el Tipo de establecimiento según los datos de ingreso de los pacientes en los establecimientos de salud.')
